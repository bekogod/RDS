...
control MyIngress(inout headers hdr,
    ...
    action set_labels_tunnel1() {
        ...
        standard_metadata.egress_spec = 2; //porta 2 para sair tunel 1
}
    ...
    action set_labels_tunnel2() {
        ...
        hdr.mslp_labels[1] = {0x5020, 0, 0};
        hdr.mslp_labels[1].setValid();

    
        hdr.mslp_labels[0] = {0x6020, 0, 0};
        hdr.mslp_labels[0].setValid();
        
        standard_metadata.egress_spec = 3; //porta 3 para sair tunel 2
    }
